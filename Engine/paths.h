...
#define OBJECTS_CSV_FILE_PATH       MERGE(USER_PATH,ZELDA_STARTING_LEVEL_OBJECTS_CSV_PATH)
#define TITLE_MUSIC_PATH            MERGE(USER_PATH,ZELDA_II_TITLE_SCREEN_MUSIC)
#define ATTACK_SOUND                MERGE(USER_PATH,ZELDA_II_ATTACK_SOUND)
#define LEVEL_MUSIC_PATH            MERGE(USER_PATH,ZELDA_II_PALACE_LEVEL_MUSIC)
